...
class ReverseColorBoxSlider extends StatefulWidget {
  ReverseColorBoxSlider({Key? key}) : super(key: key);

  @override
  _ReverseColorBoxSliderState createState() => _ReverseColorBoxSliderState();
}

class _ReverseColorBoxSliderState extends State<ReverseColorBoxSlider>
  ...
  void initState() {
    ...
    for (int i = 0; i < cl.length; ++i) {
      widgets.add(Expanded(
          child: DrawBit(
        size: Size(50, 100),
        color: animations[18 - i - 1],
        controller: cl[18 - i - 1].controller,
      )));
    }
  }
