...
class ColorBoxSlider extends StatefulWidget {
  ColorBoxSlider({Key? key}) : super(key: key);

  @override
  _ColorBoxSliderState createState() => _ColorBoxSliderState();
}

class _ColorBoxSliderState extends State<ColorBoxSlider>
